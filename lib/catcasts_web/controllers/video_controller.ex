defmodule CatcastsWeb.VideoController do
  ...
  def index(conn, params) do
    page = params["page"] || 1
    videos = Multimedia.list_videos(:paged, page)
  ...
  def create(conn, %{"video" => video_params}) do
    case YoutubeData.has_valid_url?(video_params) do
      ...
      url_info ->
        [video, message] = YoutubeData.insert_or_get_video(url_info, conn.assigns.current_user)
  ...
  defp check_video_owner(conn, _params) do
    ...
    case video.user_id == conn.assigns.current_user.id do
      true ->
        conn
      false ->
        conn
